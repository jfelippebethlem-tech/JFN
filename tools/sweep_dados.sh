...
if [ -f data/.pause_grafo_persistir ]; then say "grafo persistir pausado — pulei"; else JFN_SWEEP_FATIA=0/2 $PRIO timeout 900 $PY -m tools.grafo_persistir --limite 420 >> data/grafo_persistir.log 2>&1; say "grafo persistir rc=$?"; fi
