...
- 2026-08-06 (madrugada): **I6 de 6 para 2, em quatro camadas — e cada uma só apareceu porque a anterior foi conferida no processo real, não no teste.** (1) *"atesto **a ser realizado**"* era cláusula de pagamento, não ato — o **infinitivo** separa; (2) com isso corrigido o achado **reapareceu** vindo do próprio contrato (*"devidamente atestado pelo(s) agente(s) competente(s)"*): o instrumento atestava a si mesmo, e a guarda virou **princípio** — o atesto é peça POSTERIOR e DE OUTRO documento (família **24**); (3) o terceiro comparava *"13 servidores"* com *"6"* de um **Atestado de Capacidade Técnica da UFC**, peça do licitante sobre outro contrato; (4) **o veto disso não pegou**, porque escrevi a fixture de memória — o título real é `Atestado _de_Capacidade_Tecnica`, com underscore e sem acento, vindo do nome do arquivo (família **24.1**: fixture de string do mundo se copia verbatim). 🔍 A evidência passou a **nomear os dois lados** da comparação; foi isso que expôs a camada 3. Nos dois achados que sobraram os autos contam a história: no nº 1 da fila, contrato 16/2023 para **04 aeronaves**, 2º TA reduz para **03**, Parecer 462 discute a *"REDUÇÃO EM 25% (1 AERONAVE)"* e o **Despacho Saneador** já levanta o ponto. Acervo: **EXTREMO 15 · ALTO 240 · MEDIO 32 · BAIXO 1.478 · NAO_AVALIAVEL 410**. Suíte 4 lotes: **1.275 + 1.323 + 1.373 + 1.900 passed, 6 skipped, 0 falhas**.
- 2026-08-05 (madrugada final): **abri os nºs 6 e 7 da fila e o achado se desfez em duas camadas — a segunda virou regra nova.** 🚗 O I6 acusava *"30 veículos contratados e o atesto fala em 3"*. O "3" era a **distribuição interna do próprio objeto** (*"21 para as Operações Presente; 03 para a Barreira Fiscal"*) e o gatilho de atesto era a cláusula de **pagamento** do TR (*"mediante atesto **a ser realizado**"*) — total contra parcela, num papel que não atesta nada. Corrigido pelo modo verbal; um teste da casa pegou o excesso, porque recusar o artigo derrubava *"ATESTO **a** boa execução"*, verdadeira — o que separa ato de promessa é o **infinitivo**. 🔁 **Aí o achado REAPAREÇEU por outro caminho:** o gatilho passou a vir do próprio **contrato**, na fórmula que todo contrato tem (*"devidamente atestado pelo(s) agente(s) competente(s)"*). O instrumento atestava a si mesmo. A guarda deixou de ser texto e virou princípio — **o atesto é peça POSTERIOR e DE OUTRO documento** —, e a reincidência virou o critério de parada: *estou consertando a FRASE ou o ARRANJO?* Família **24** do CATÁLOGO. I6 **6 → 5 → 3**; os 3 restantes têm documentos distintos e quantitativo inequívoco (13 servidores × 6 · 3 aeronaves × 4 · 18 veículos × 15). 🚚 Antes disso, a recaptura: **`--processo`** para alvo nomeado, uma tentativa sem ganho deixou de excluir o processo **para sempre** (7 dias e volta), `faltam: 0` no teto passou a declarar **lacuna DESCONHECIDA** em vez de mentir zero, e o `--recaptura` — que existia desde 03/08 e **ninguém chamava** — entrou no sweep com orçamento medido. Corrigi em público minha estimativa de cadência: o ciclo é de **~3h**, não 30 min, e a drenagem é de ~16 processos/dia sobre 537. Acervo: **EXTREMO 15 · ALTO 240 · MEDIO 32 · BAIXO 1.478 · NAO_AVALIAVEL 410**. Suíte 4 lotes: **1.275 + 1.323 + 1.373 + 1.898 passed, 6 skipped, 0 falhas**.
- 2026-08-05 (noite alta): **o nº 1 da fila do fiscal estava truncado, e a ferramenta que o consertaria nunca rodava.** 🎯 Dei alvo nomeado à recaptura (`--processo`, porque a fila é ordenada por lacuna e `--max` corta do começo — recapturar o processo mais importante não podia depender de ele ser o menor) e rodei no **SEI-270131/000548/2023**: **40 → 65 documentos** (+25, 381.444 caracteres). Ele saiu de `NAO_AVALIAVEL` para **EXTREMO, score 94,9 — o mais alto do acervo**, com os 7 achados preservados, entre eles o `I3` crítico (*"o ato traz MINUTA DE DOCUMENTO no topo; nomeia RACHEL LOPES DA SILVA como quem DECIDE, e a assinatura é de Renato de Melo Cardoso"*). Antes a faixa era **recusada** por leitura incompleta; agora se apoia na árvore inteira — e um dos 25 documentos novos derrubou o A3 de `medio` para `baixo`, que é a demonstração direta do que o teto escondia. ⚙️ **Terceira mordida da família 8:** `sei_sweep --recaptura` existia desde 03/08 e **nenhum agendamento o acionava** — a fila de 540 não tinha drenador. Entrou no `sweep_sei.sh` (não em cron próprio: a sessão itkava é única), `--max 2`, com pausa por arquivo. A catraca ganhou a entrada e fiz a **prova negativa** antes de confiar nela. A pergunta certa não é "existe caller?" e sim **"existe caller AGENDADO para este MODO?"** — uma flag é órfã mesmo em ferramenta que o cron chama todo dia. 💰 **C9:** o `diz` que o fiscal lê trazia só o múltiplo (*"3,2× a norma local"*) enquanto a razão que importa ficava no dossiê — *"86,9% do valor pago via TAC (**R$ 52.829.081,39** de R$ 60.772.657,25; 15/32 OB)"*. Múltiplo sem base ordena mal a fila. ⚖️ **I4:** o código conferia a hipótese inocente desde 04/08 e o texto seguia dizendo *"precisa ser conferida nos autos"* — ressalva testada não pode continuar escrita como pendência. Acervo: **EXTREMO 15 · NAO_AVALIAVEL 410**. Suíte 4 lotes: **1.460 + 1.378 + 1.778 + 1.239 passed, 6 skipped, 0 falhas**.
- 2026-08-05 (fim de tarde): **três correções encadeadas, e a mais grave foi a etiqueta elegendo o marco da cadeia.** ⚖️ **CD_ (família 23):** dos 24 achados de inversão da ordem legal da despesa (arts. 60, 62, 63 da Lei 4.320), **19 (79%) apontavam peça que não é da fase alegada** — 6× *"Planilha de Controle de Faturamento"* tipada **PAGAMENTO**, 4× *"Correspondência Interna"* tipada liquidação, além de *"Documento Trabalhista"* e *"Declaração NÃO RETENÇÃO INSS"*. `_marco` casa por tipo **OU** título, e o `OU` deixa a etiqueta decidir. A cura já existia no repositório: o A1 exige dupla concordância desde julho. Agora a cadeia orçamentária exige a **marca do ato** no título (nome da peça ou número SIAFE `20XXNE`/`NL`/`OB`). CD_ **24 → 10**. 🚚 **Recaptura (correção de uma afirmação minha):** eu havia escrito "os 176 voltaram à fila — conferido", tendo conferido só que `_arquivo_incompleto` devolve True — isso prova que não serão PULADOS, não que serão OFERECIDOS. Medindo: 137 pelo `sweep_sei`, 57 pela recaptura integral, união 150 — **26 eram órfãos sem rota nenhuma**. A fila da recaptura passou a ler o ARQUIVO, não só o cache: **órfãos 26 → 0**, fila 197 → 540. O cache deu a prova direta do teto: `cdp_SEI_170002_000732_2022` registra **árvore de 783 documentos contra 40 lidos**. 🖥️ **Painel:** contava como íntegros os mesmos 176 que o motor recusa — duas réguas para o mesmo fato. Alinhadas: íntegro **1.941 → 1.765**, balde novo `teto_de_coleta` = 176, utilizável 4,9% → 4,4%. Exigiu `systemctl --user restart jfn` (o serviço tinha o módulo velho em memória). Acervo: **EXTREMO 14 · ALTO 240 · MEDIO 34 · BAIXO 1.476 · NAO_AVALIAVEL 411**. Suíte 4 lotes: **1.433 + 1.825 + 1.178 + 1.417 passed, 6 skipped, 0 falhas**.
- 2026-08-05 (madrugada seguinte): **auditei as 3 famílias de "fase ausente" e abri o processo de maior score do acervo; no caminho fabriquei 175 achados e os peguei lendo a própria evidência deles.** ✅ **Confirmam sem exceção:** `F_SELECAO` (26 — nenhum tem edital, pregão, homologação, adjudicação, ata ou proposta) e `F_PLANEJAMENTO` (48 — nenhum tem TR, ETP, DFD, projeto básico ou pesquisa de preços). ⚖️ **Corrige — `F_CONTRATACAO` (21):** 9 têm **Nota de Empenho** e nenhum termo de contrato, e o art. 95, §1º da Lei 14.133/2021 (art. 62 da 8.666/93 até 2023) **admite a substituição** nas hipóteses legais. 21 média → 12 média + 9 baixa, citando a base e apontando a peça. (`Contrato Social`, presente em 7 deles, é habilitação do licitante — corretamente classificado.) 🔎 **O maior score do acervo (SEI-070002/001289/2022, 90,2):** a evidência do E7 chegava cortada em *"…quadro permanente, na data da Concorrência, profissional ou"*, perdendo o que decide — *"cópia de sua ficha de registro de **EMPREGADO**"*, vínculo exigido na data da licitação. O `_trecho_completo` existia e nunca recebia o texto do edital. Ligado: **101 → 287 caracteres**. 🧨 **E o erro que cometi ligando:** usei a chave `tr_texto`, e a reavaliação devolveu **175 achados P1 do nada, 44 críticos** — todos falsos, denunciados pela evidência que imprimiam (*"MARCA: N/C"* de termo de recebimento, cabeçalho `LOTE | VALIDADE | Marca`, e-mail de *troca de marca*). `_fontes_de_edital` aceita documento pelo CONTEÚDO, o que é certo para achar cláusula e errado como "descrição do item". Chave própria (`edital_texto`) resolveu: P1 zerado, E7 nos 13, EXTREMO de volta a 14. **Chave de contexto é contrato semântico, não saco de texto** — família 18.1 do CATÁLOGO. Suíte 4 lotes: **1.367 + 2.003 + 1.178 + 1.277 passed, 6 skipped, 0 falhas**.
- 2026-08-05 (noite): **o gate de integridade respondia a pergunta errada, e metade do topo da pirâmide de risco estava apoiada em captura truncada.** Investigando os 33 achados de "nenhum parecer jurídico localizado (art. 53)", as contagens de documentos chamaram atenção — 40, 40, 40, 39, 39. Medindo o acervo: dos **1.902 arquivos montados do CACHE do sweep, 176 param em exatamente 40 documentos e ZERO passa de 40**; nos 274 de outra origem não há muro nenhum. É o corte `documentos[:40]` que existia no sweep, hoje removido do código (`SEI_MAX_DOCS=120`), **congelado nos arquivos**. `captura_integra` media densidade de TEXTO — 40 de 40 com teor, logo "íntegro" — mas a pergunta dele é *"capturei tudo?"*, não *"li tudo o que capturei?"*. Esses 176 sustentavam **134 acusações de AUSÊNCIA** e **14 dos 28 processos EXTREMO**. Regra de duas condições, cada uma medida (origem no cache **e** contagem no teto); 39 segue íntegro, 40 de outra origem também. **O ciclo fecha sozinho:** `sei_sweep._arquivo_incompleto` usa a MESMA função, então os 176 voltaram à fila de recaptura — conferido. Reavaliação: **NAO_AVALIAVEL 235 → 411, EXTREMO 28 → 14, ALTO 290 → 242**, `fases.lacunas` 457 → 352. Família **22** do CATÁLOGO. 🖥️ Painel ajustado à nova realidade: severidade ao lado do código no Estado do motor (`F_EXECUCAO_SEM_EVIDENCIA (251 crítica · 68 média)`), verificado no DOM da página viva com `pageerror` limpo. Suíte 4 lotes: **1.910 + 1.373 + 1.209 + 1.326 passed, 6 skipped, 0 falhas**.
- 2026-08-05 (tarde): **verifiquei o maior achado do acervo e os dois cortes por posição do motor; os três estavam errados, e um deles ao contrário do que eu esperava.** 📦 **`F_EXECUCAO_SEM_EVIDENCIA` (319 processos, quase metade dos 667):** a primeira medida deu **93% de "atesto"** — quase todo *"ATESTO e CERTIFICO a regularidade da **liquidação da despesa**"*, que é o ato financeiro, não a entrega; tratá-los como iguais teria esvaziado o maior achado do acervo com prova que não é prova. Com a distinção certa: **69 (21,6%)** declaram a entrega no TEXTO de peças cujo título não anuncia execução (*"Ofício - NI 196/2024"*), inclusive a PGE lendo a NF *"assinada por dois servidores"* (art. 90, §3º, Lei Est. 287/79). 319 → 251 críticas, +68 médias; ALTO 353 → 290. ✂️ **Dois cortes por posição, ambos fabricando erro** (família **20**): o `[:40]` do acatamento fazia 26 processos perderem 1.165 despachos e 54 pareceres — 2 vereditos mudavam **retratando acusação** (`SEM_PARECER_LOCALIZADO`/`SILENTE` → `ACOLHIDO`); e o `[:12]` do contratado dava **empate 1×1** e elegia o **ITERJ** como fornecedor de si mesmo, com a **SEGOV** (4×) e a **SECID** no mesmo padrão — a família C inteira examinaria o contratante. Nenhuma das três está em `empresas_cadastro`; quem resolve é o TEXTO, e o veto é **por CNPJ, não por ocorrência** (o próprio teste da regra mostrou que o órgão ganha por repetição no cabeçalho). Fornecedor **59 → 69** achados: a correção aqui AUMENTA a acusação, honestamente. ⚖️ **E o C3/C5 afirmava fato falso** (família **21**): a Cruz Vermelha saía CONFIRMADO/ALTO peso 20 com *"Inapta na Receita Federal **desde 31/03/2005**"* — data em que o dump citado como fonte registra **ATIVA**. Dos 374 CNPJs ditos irregulares, **118 (31,5%) estão ativos no dump**. Não elegi vencedor (cadastro de jul/ago, dump de maio): conflito degrada para indício baixo e manda conferir na origem; o IDESI (INAPTA 28/01/2026, OB 23/03/2026) mantém peso 20. C3/C5 alta 13 → 8. Suíte 4 lotes com a VM ociosa: **1.906 + 1.362 + 1.206 + 1.340 passed, 6 skipped, 0 falhas** — uma rodada com load 4,47 deu 12 vermelhas por **contenção com o sweep**, não regressão.
- 2026-08-05 (manhã): **fui aos autos dos achados mais graves e voltei com três correções, uma delas no topo da fila do fiscal.** ⚖️ **A3:** o achado dizia "nenhum documento registra acatamento do parecer" e o SEI-070002/013107/2024 desmentia — o **Ato de Reconhecimento de Dívida 86639308** enumera os procedimentos do art. 14 do Decreto 41.880/2009 citando o parecer pelo identificador; o classificador o tipa `parecer`, então ficava fora do conjunto de respostas. Regra casa por título de ato decisório **e** exige que ele cite o parecer — alargar por tipo importaria ruído puro (planilha de BDI com "acabamento", edital com "Impugnação **não** acatada"). Controle negativo segura: SEI-080001/036964/2025 tem ato decisório, não cita, segue `medio` — e é o caso verdadeiro (CIB 1.237/2025 nunca referendada). 🚨 **A cabeça da fila estava tomada por um sinal que não existia:** as posições 3 a 9 (sete `C/EXTREMO`, todos da UG 080001) traziam *"parecer IGNORADO pela autoridade"*, **+4 pontos**. Os **10 vereditos `IGNORADO_INDICIO` do acervo — 18 ocorrências, 100% delas** — saíam da MESMA frase de praxe da PGE: *"o **descumprimento** das normas nele previstas deve ser apurado conforme a legislação"*, que descreve a regra em abstrato. `descumpr` cru lia hipótese normativa como fato consumado. Trocado por formas que AFIRMAM; os 10 caem para `SILENTE` — a imputação que flertava com improbidade sai, a observação verificável fica. **EXTREMO 38 → 28.** Família **19** do CATÁLOGO. 🏷️ **E o instrumento estava cego duas vezes:** o diff imprimia "sem mudança" para correção que só muda **grau** (código é o mesmo nos dois), e **532 dos 667 achados (80%)** nasciam **sem código**, num balde `—`. Código estável por família (`F_`/`CD_`/`AC_`/`SE_`, nunca `A1`/`A2` — o ranking usa esses prefixos para decidir peso) + catraca estática com **prova negativa feita antes de confiar nela**. Com o balde seco apareceu o maior número do sistema: **`F_EXECUCAO_SEM_EVIDENCIA` = 319 de 667** — pagamento sem evidência de execução é quase metade dos achados. Suíte 4 lotes: **5.800 passed, 6 skipped, 0 falhas**.
- 2026-08-05 (madrugada): **perguntei QUAL dado falta e achei dois fios soltos — um rendeu, o outro eu apaguei.** A cobertura recém-criada mostrou os motivos de "não pude avaliar": **vigência do contrato ausente em 100% dos 2.174 processos** (X2 e X8 mudos) e **"menos de 2 cotações" com 2.842 ocorrências** (família P inteiramente desalimentada). 🔌 **Fio 1 — vigência:** o dado existia em `contratos_tcerj`, o caminho do TCE já o usava, o do SEI não. Ligado (195 processos): o X2 passou a avaliar em 52 de 60 na amostra e produziu o **primeiro achado NOVO da sessão** — EXTREMO, "23,01 anos de vigência". Fui aos autos: é a **"AQUISIÇÃO DO MEDICAMENTO CIPROFLOXACINO por R\$ 58.608,00"**, compra pontual — `vig_inicio` de 2002 é erro no registro da fonte. **O fio que eu acabara de ligar teria entregue um EXTREMO falso.** Invariante de plausibilidade (mesma doutrina do X9): acima de 15 anos não há hipótese legal, então o detector diz o que não fecha e manda conferir a data. Duas contenções escritas no código: `valor_inicial` não sobrescreve a extração do texto (calibrada por força da declaração) e `vigencia_fim` **não** é preenchida, porque a tabela não distingue a original da prorrogada e medir retroatividade contra baseline errada é pior que não medir. 🏭 **Fio 2 — cotações: APAGUEI o extrator que escrevi.** Ele devolvia **três CNPJs com o mesmo R\$ 480.000,00** — o padrão que o P2 caça — e eram a **Prefeitura de São Paulo** e a vencedora de OUTRO pregão, vindas do painel Compras Governamentais; as cotações reais estavam em `899400,0000`, formato que a regex nem casava. Entregaria **conluio fabricado a partir de citação de painel**. Código que não roda é a família 8; código que roda e fabrica indício é pior que ausência de dado — virou família **18** do CATÁLOGO, com o roteiro do que a próxima tentativa precisa saber. ⚖️ Detectores: **E1 6 → 0** (lia contrato social do licitante como exigência do edital, corrigido nos DOIS níveis) e **I6 7 → 6** (comparava a primeira quantidade entre uma dúzia). 📊 Painel: **réguas que conseguem aferir cada processo — mediana 5 de 43**, com 26 sem dado (máx 41); e corrigi uma afirmação minha de que seriam 17 (era um processo rico, não a mediana). Suíte 4 lotes: **5.798 passed, 6 skipped, 0 falhas**.
- 2026-08-04 (madrugada seg.): **parei de repetir o ciclo à mão e ataquei a RAIZ do retrabalho.** 🔁 `processo_360.py --lote N` escolhia "os N maiores por número de documentos" — os **MESMOS 120 processos a cada 4 horas, para sempre**: o acervo nunca convergia depois de uma correção, e foi isso que me obrigou a rodar passadas manuais **cinco vezes num dia**. Virou RODÍZIO (nunca avaliado na frente, depois o mais desatualizado por `avaliado_em`): 720/dia, acervo inteiro em ~3 dias, correção chegando em todo lugar sem ninguém empurrar. 🛠️ **`tools/pos_correcao`**: um comando faz fotografar → reavaliar → regravar a fila → **diff do que mudou**. É retomável (duas passadas minhas morreram no meio hoje e perderam 375 e 100 processos), não começa com load ≥ 4 e não roda a suíte de propósito. Primeira execução ponta a ponta: 2.174 processos, zero erros, `A3 27 → 20` batendo com a medição manual. 🔌 **Catraca "ferramenta tem quem a rode"** — a falha que mais se repete nesta casa (o `sei_reparar_vazios` ficou 11 dias sem caller com a docstring *"por isso esta ferramenta roda primeiro"*). Regra literal, decidida por `grep`: ferramenta periódica é citada por um sweep DO REPOSITÓRIO. Reprovou na primeira execução o `sei_reparar_truncados`, que estava **solto no crontab** — e linha solta é o que ninguém audita, foi assim que a MESMA linha ficou duplicada. Consolidado no sweep_dados, com guarda de load e flag de pausa. 🤖 **Duas garantias de rodar SEM IA**: `avaliar()` é `com_llm=False` por padrão e o lote do cron não passa `--com-llm`; a pipeline não invoca LLM. Se alguém ligar IA no caminho determinístico, o teste quebra. 📖 **`docs/RUNBOOK.md`**: operação passo a passo com resultado esperado e a lista do que exige PARAR e perguntar — feito para IA fraca ou para ninguém. ⚖️ Detectores: **A3 27 → 20** (o aviso de que o parecer *não vincula o gestor* casava o padrão de ressalva pelo "desde que", em 4 disparos com texto idêntico em três órgãos) e **9 dos 20 restantes passaram a dizer que HÁ resposta** que se reporta ao parecer, em vez de afirmar ausência. 📊 Painel: cartão **Estado do motor** (achados por código e origem) usando a MESMA função do diff — painel e pipeline não podem divergir. Suíte 4 lotes: **5.750 passed, 6 skipped, 0 falhas**.
- 2026-08-04 (noite): **a fila de recaptura era uma lista curada UMA VEZ, e o reparo apagava o trabalho do sweep.** 📋 `--cap` refilava pela `recaptura_cap21k.json`, feita à mão em 01/08 (375 processos) e nunca regerada: o acervo tem **2.025 documentos no cap em 446 processos**, ela cobre 343, ignora **103 novos** e traz 32 já resolvidos. Alvo passa a ser **medido a cada rodada** e se autocorrige (processo recapturado com o cap de 60k sai sozinho, o que dispensa a lista de 'prioridade'). 🧨 **O reparo APAGAVA o progresso**: as três vias faziam read-modify-write com MINUTOS entre a leitura e a escrita (a medição do cap leva 1-2 min) enquanto o sweep grava no mesmo arquivo o tempo todo — cada processo lido some. É a família "índice sem merge apaga trabalho", e o `sei_sweep._salvar_prog` já a tinha aprendido em 10/07 (274 leituras perdidas); só o reparo estava fora. 🕐 **E o crontab tinha a MESMA linha duas vezes, no mesmo minuto** — 80 processos refilados por dia e duas dessas varreduras concorrentes; era a única duplicata exata, removida com backup e verificação encadeada. 🎯 Alvo dirigido (`--processo`) porque processo com UM documento cortado fica no fim da ordenação e nunca entraria numa rodada bounded — refilei o **segundo da fila do fiscal**, cujo contrato para em 20.000 exatamente onde ficam assinatura e data. ⚖️ **A3 verificado nos autos:** um disparo se ancorava numa MINUTA revisada e cobrava acatamento de cláusula dela, com a sequência posterior (minuta → Resolução → publicação) sendo o controle FUNCIONANDO (28 → 27); outro se confirmou **verdadeiro e grave** — o parecer registra que a Deliberação CIB nº 1.237/2025 não foi referendada e recomenda ratificação, e os 18 documentos seguintes vão direto a NAD, empenho e liquidação sem uma menção. Suíte 4 lotes: **5.720 passed, 6 skipped, 0 falhas**. **38 commits** no dia.
- 2026-08-04 (tarde): **persegui um achado até o fim e caí numa família inteira — três vezes o mesmo defeito: casar MENÇÃO em vez de FONTE.** Comecei conferindo um C3/C5 de fornecedor INAPTA e a prova chegava truncada no meio da palavra (`str(dict)[:120]` serializava o repr inteiro); ao conferir o valor pago, o espelho TFE mostrava **5,5× mais** que o SIAFE para o mesmo CNPJ, tudo na UG 294200. 🔢 **A fonte canônica estava truncada:** 23 pares (UG, ano) parados em **exatamente 1.000 registros** de 642, enquanto outros chegam a 6.836 — é o teto da consulta de OB Orçamentária, e varredura feita só com `--por-ug` para ali em silêncio; nesses 23, SIAFE **R$ 8,46 bi** contra **R$ 19,26 bi** no espelho (**137.654 OBs a menos**). Não era defeito de código (os três caminhos que furam o teto já existiam): faltava **medir que a coleta parou** → `reporting/cobertura_siafe`, `/api/siafe/truncamento`, cartão com o comando de recoleta de cada par, entrada em `limites_de_fonte`, catraca que só deixa o número cair. 🗓️ **Situação cadastral aferida HOJE e cobrada como se fosse à ÉPOCA:** `H-SITUACAO` saía CONFIRMADO/peso 20 dizendo "pagamento a empresa não-ativa é vedado" — dos 75 CNPJs hoje irregulares que receberam do Estado, **59 (78,7%) tiveram TODO o pagamento ANTERIOR** à irregularidade (o maior: R$ 9,37 mi até 28/11/2023, BAIXADA só em 26/12/2025). O dado existia o tempo todo (`receita_estab.db` tem `data_situacao`, 0 ms por consulta). ⚖️ **Parecer que CITA a PGE virava parecer DA PGE:** 67 de 210 (32%) eram da diretoria jurídica do próprio órgão — e como PGE vale nível 3 (controle EXTERNO), a casa creditava a si mesma o controle externo. 📄 **Contrato que cita a PGE entrava como manifestação dela:** dos 99 documentos com sinal de "não atendida", só **19 eram parecer** (20 eram contrato, resto anexo/TR/recurso/ETP), e cláusula padrão ("Persistindo a irregularidade, o CONTRATANTE deverá adotar as medidas") virava prova de recomendação ignorada na fila do fiscal → **99 → 20**, com os 19 verdadeiros preservados. E o mesmo portão faltava na **suficiência do art. 53**: certidão de FGTS, extrato de TAC e telas de portal sustentavam "tem parecer da PGE" — **391 processos mudam de veredito** (li a amostra dos barrados antes de aceitar: nenhum parecer). 🔁 **"reitera-se" retórico** era sinal de descumprimento em 49 de 73 (67%). 🚪 **Desistir virou regra:** o sweep abandonava após 3 tentativas PARA SEMPRE — 2.760 assim, nas MESMAS unidades onde milhares foram lidos, com o **primeiro da fila por dinheiro** (R$ 210 mi) entre eles; tentativa passa a EXPIRAR em 14 dias (1.977 voltam), acesso RESTRITO confirmado não é remartelado **mas a marca também expira** (90d), e a retentativa ganhou **cota de 1/3 intercalada** depois que medi que ela tomava **71% da capacidade** rendendo zero. ⏱️ **406 colisões de 600s no browser_lock** (o cron abria ciclo por cima do anterior porque o guard só via o primeiro estágio) → trava de ciclo por PID, **não `flock`** (fd herdado por chromium órfão travaria o sweep para sempre). 🕳️ **Documento presente e ILEGÍVEL contava como capturado** na conferência do parecer: 72 documentos em 16 processos, entre eles o próprio Termo de Ajuste de Contas de um pagamento de R$ 6,5 mi. 📊 **Superfície nova no painel:** cobertura de captura agora separa "nunca tocado" de "tentado e classificado como restrito" (**442 de 1.268 com veredito, 33,9%**, ordenado por VALOR — 93% de uma unidade que pagou R$ 0,9 mi não é o maior ponto cego; o bloco da Saúde soma ~R$ 2,73 bi), e o **ranking de TAC por unidade** mostra a Fundação Saúde em **27,0% (R$ 2,81 bi)** contra **mediana de 0,3%** entre 56 unidades — e 2,8% no Fundo Estadual da Saúde, três vezes maior. 🧭 **Duas honestidades:** o IDESI/FSERJ que persegui **já era o caso fundador** do detector TAC e já tinha a data da inaptidão em fonte primária no vault (apaguei a nota duplicada), e o texto sobre restrição foi reescrito para atribuir a classificação ao registro de controle, não a "porta fechada" nossa — a casa tem regra de **nunca culpar acesso**. 🧨 **E o achado mais perigoso do dia veio de destravar uma ferramenta:** `sei_reparar_vazios` relatava "nada a reparar" com 7.682 documentos vazios porque media o arquivo COM a etiqueta (que sozinha passa dos 80 chars). Corrigido isso, ela achou 24 candidatos — e o casamento posicional `integra/<i>.pdf` ↔ documento `i` **NÃO VALE**: dos 7 conferíveis, **6 traziam o PDF de outro documento** ("NAD 3378" devolvia um despacho; "Anexo IRRF" devolvia um e-mail; o mesmo arquivo de 18 MB aparecia em dois processos sob índices diferentes, md5 idêntico). Teria gravado 23 documentos trocados — **vazio é lacuna declarada, trocado é prova falsa**. Passa a exigir PROVA (o id SEI do título no texto extraído): 5 recuperados, 19 recusados. 🔍 **Com os 5, li o que estava mudo:** a minuta do TAC nº 2000/2024 (26.455 chars) do processo de R$ 6,5 mi da AMC/Grupo Caneca — e o resultado **desinfla** a suspeita: o Checklist do processo responde item a item o Enunciado nº 08 da PGE (boa-fé, regularidade fiscal, custo e lucro), com id de documento em cada resposta. O que resta é o mérito da resposta de preço, e os dois documentos que o testariam (TAC assinado e pesquisa de preços de 42 páginas) exigem recaptura — o PDF no lugar deles é de outra peça. 🔦 **E o maior de todos, achado porque uma guarda minha não mudou número nenhum:** `sei_triagem_pericia._texto_do_doc` localizava o arquivo por **glob do identificador no NOME** — e o nome é o título sanitizado e CORTADO, então em título longo o id não está lá. Medido: **5.722 dos 33.584 documentos com teor (17%) eram lidos como VAZIOS**, e com eles **56,5 milhões de caracteres** ficavam invisíveis para o A1, o A2 e a auditoria de acatamento — os três que decidem sobre o art. 53. O manifesto sempre trouxe o caminho no campo `texto`. Depois: **0**. Junto, duas guardas no A1 medidas caso a caso (**10 → 4**): nota técnica pura não é o parecer do art. 53 (a de SEI-510001/001309/2025 é da Subsecretaria de Fiscalização, assinada *"na qualidade de Fiscais do Contrato"*, posterior por natureza ao contrato que fiscaliza) e parecer SEM TEXTO não ancora conclusão. O que os falsos tinham em comum: contrato PRÉ-EXISTENTE juntado como anexo a processo posterior. Famílias **15 e 16** do CATÁLOGO. Suíte 4 lotes: **5.710 passed, 6 skipped, 0 falhas** (a catraca de `except Exception` pegou uma captura genérica minha e foi paga); **~50 testes novos**; acervo reavaliado 5× ao longo do dia; **32 commits**.
- 2026-08-04 (tarde): **desistir estava virando regra, e a fonte canônica estava truncada.** 🔁 **O sweep abandonava processo após 3 tentativas PARA SEMPRE** — 2.760 assim, nas MESMAS unidades onde milhares foram lidos (UG 080002: 826 abandonados contra 1.284 lidos), ou seja falha intermitente, não falta de acesso; entre eles o `SEI-150001/011573/2021` (R$ 210 mi, **o primeiro da fila por dinheiro**) e o I.D.E.A.S `SEI-080001/005089/2022` (R$ 135 mi): a fila propunha justamente o que o sweep tinha desistido de ler. A tentativa passa a EXPIRAR em 14 dias (**1.977 voltam à fila**; os 629 recentes seguem protegidos), e os 311 com acesso RESTRITO confirmado não são remartelados — mas **essa marca também expira**, em 90 dias, senão eu teria trocado uma isenção permanente por outra (terceira ocorrência da família, depois de `captura_vazia` e do arquivo sem teor). ⏱️ **406 colisões de 600s no browser_lock**, 4 a 10 por dia: o cron `*/30` abria ciclo por cima do anterior porque o guard só enxergava o PRIMEIRO estágio; trava de ciclo por PID — **não `flock`**, cujo fd herdado por chromium órfão travaria o sweep para sempre, que é pior que a contenção. 🔢 **23 pares (UG, ano) do SIAFE parados em EXATAMENTE 1.000 registros**, de 642, enquanto outros chegam a 6.836: é o teto de consulta da tela de OB Orçamentária, e varredura feita só com `--por-ug` para ali em silêncio. Nesses 23, SIAFE **R$ 8,46 bi** contra **R$ 19,26 bi** no espelho TFE (**137.654 OBs a menos na fonte que a casa trata como verdade**). Não é defeito de código — os três caminhos que furam o teto já existiam; faltava **medir que a coleta parou**: novo `reporting/cobertura_siafe`, rota `/api/siafe/truncamento`, cartão no painel com o comando de recoleta de cada par, entrada em `limites_de_fonte` e catraca que só deixa o número CAIR. Apareceu **perseguindo um achado até o fim**: o espelho mostrava 5,5× mais pagamento que o SIAFE para o mesmo fornecedor. 🗓️ **A situação cadastral era aferida HOJE e cobrada como se fosse à ÉPOCA** — `H-SITUACAO` saía CONFIRMADO/peso 20 escrita *'pagamento a empresa não-ativa é vedado'* sem comparar datas: dos 75 CNPJs hoje irregulares que receberam do Estado, **59 (78,7%) tiveram TODO o pagamento ANTERIOR à irregularidade** (o maior: R$ 9,37 mi até 28/11/2023, BAIXADA só em 26/12/2025). É a família do caso Fênix, e o dado existia o tempo todo — `receita_estab.db` tem `data_situacao` indexado por CNPJ, 0 ms. Três ramos honestos (anterior → INDÍCIO sobre a situação ATUAL; posterior → CONFIRMADO com a data, como o IDESI, INAPTA em 28/01/2026 com OB em 23/03/2026; sem data → declara o limite). Alcança Lex, `/orgao`, 360 e o sweep DD; **medido antes de agir: nenhuma das 8 avaliações gravadas muda**, o ganho é prospectivo. 📄 **A prova do achado de fornecedor chegava truncada no meio da palavra** (`str(dict)[:120]` serializava o repr inteiro) — o C3/C5 de um fornecedor com R$ 92,37 mi aparecia como *'na Receita Federal. Pagamento/contra'*. ⚠️ **E um defeito meu, medido e curado na mesma sessão:** o `_restrito_confirmado` que escrevi reparseava 419 KB por processo (9,5 s por passada, ~95 s por ciclo). **Redescoberta honesta:** o IDESI/FSERJ que persegui já era o caso fundador do detector TAC e já estava no vault com a data da inaptidão em fonte primária — apaguei a nota duplicada. Lição no vault: `aprendizados/contagem-redonda-e-assinatura-de-truncamento.md`. **26 testes novos**, 6 commits.
- 2026-08-04 (manhã): **varri a fila de risco detector a detector — TODA taxa alta era defeito de leitura, nenhuma era padrão de irregularidade.** Sete famílias, o mesmo desfecho: `A2` **80→1** (o manifesto CRU diz `tramitacao` e a regra procura `despacho`: 174 despachos invisíveis viravam "silêncio administrativo" — o `manifesto_norm.normalizar` existe para isso e não era chamado), `X3` **56→3** (`data_empenho == data_pagamento` em TODO disparo: a mesma data lida duas vezes; e o "pago antes do atesto" saía de uma página **"Detalhamento de Empenho"** — empenho chamado de pagamento), `A3` **39→28** (das 31 passagens que acendiam ressalva, **7 se repetiam iguais e cobriam 39 processos**: checklist da PGE, citação literal do art. 149, doutrina e rodapé de certidão), `suficiencia_emissor` **37→2** (erro **JURÍDICO**: exigia parecer da PGE para TODO contrato, quando o art. 53 entrega a análise ao órgão de assessoramento do próprio ente — e o acervo traz o mecanismo que dispensa a PGE, a *Declaração de Conformidade com a minuta-padrão*), `X1`/`X7` **6→0** (a base do contrato vinha de uma *Publicação Errata*: "acréscimo de 10.024%" sobre R$ 46.866 quando o contrato é de R$ 105.988.095,41, declarado dezesseis vezes nos autos), `X9` **3→0** ("supressão de 1603% do valor inicial" — não se suprime mais do que existe) e `fases.lacunas` execução **353→343** (89% da acusação crítica era sólida; ~10% tinham "Despacho Atestação" caindo em tramitação). 🧱 **Invariante estrutural que apareceu TRÊS vezes:** detector que PONTUA tem de APARECER — as famílias C (03/08), X e P/E/J alimentavam o `score_processo` sem virar achado, com processo em EXTREMO score 80 e nada escrito; virou forma única `achados_de_detector`, com a regra irmã **sem prova literal não entra** (eu mesmo a quebrei ao ligar o X3, que confirma com `evidencia` vazia). 🧭 **O protocolo:** medir a taxa antes de acreditar · abrir os autos · **medir a hipótese ANTES de codá-la** (três minhas foram refutadas pelos dados e NÃO viraram código — entre elas "a ressalva casa dentro de citação de norma", quando em 3 de 4 casos o texto era a EMENTA do parecer) · número impossível é leitura quebrada, não achado · a refutação vem do próprio processo, não de limiar. 📊 **Efeito na fila do fiscal:** EXTREMO **96→48**, e o topo passou a ser o caso que eu havia lido e confirmado à mão (9 achados) — antes ele ficava ABAIXO de processos com um achado só. Acervo inteiro reavaliado. Suíte 4 lotes **5.597 verdes, 0 falhas**, 40+ testes novos. Lição no vault: `aprendizados/taxa-alta-e-defeito-de-leitura.md`, família 13 do CATÁLOGO.
- 2026-08-04 (madrugada, cont.): **a fila de risco estava cheia de número lido no lugar errado — 71 achados de execução viraram 17.** Retomei pelo topo do ranking e achei um processo EXTREMO (score 80) com ZERO achados: a família X inteira pontuava no `score_processo` e **nunca virava achado** — a mesma falha que `achados_de_fornecedor` corrigira para a família C, aberta aqui. Mas tornar visível exigiu consertar o que apareceria, e aí veio a série: 🔢 **X9 anunciava "supressão de 1603% do valor inicial"** — não se suprime mais do que existe; acima de 100% é `valor_inicial` colhido do documento errado, e virou invariante físico (o processo caiu de EXTREMO 80 para BAIXO 0). ⏱️ **X3 disparava em 56 de 150 por "tríade comprimida: ciclo de 0 dias"** — TODO disparo tinha `data_empenho == data_pagamento` e liquidações fora de ordem (pagamento 01/02, liquidação 11/05; liquidação 16/06 ANTES do empenho 27/08): é a MESMA data lida duas vezes num documento que cita as duas etapas, e a regra-mãe da casa é literalmente essa (empenho ≠ liquidação ≠ OB). 🧾 **X3 "pago ANTES do atesto"** (8 disparos, R$ 61,82 a R$ 274.500,00): fui ler — a data do "pagamento" saía de uma página **"Detalhamento de Empenho"** e a do "atesto", do canhoto de uma nota fiscal. Duas curas: só a OB é pagamento e o que a identifica é o **CÓDIGO** (`2025OB000789`) — medido, 3 processos em 80 tinham código e 9 tinham só as palavras num bloco de OCR —, e **a data tem de estar PERTO do termo** (janela de 160 chars, o mesmo idioma de `instrumento_assinatura._identificador`): as "frases" do atesto tinham 780 e 506 caracteres e a data vinha de outro canto do bloco. 💸 **A RAIZ, achada lendo o contrato:** `extrair_valor_inicial` pegava a PRIMEIRA ocorrência de um padrão único e colheu `"VALOR DO CONTRATO: R$ 46.866,00"` de uma *Publicação Errata 01*; o contrato é de **R$ 105.988.095,41**, declarado DEZESSEIS vezes com fórmulas que o padrão não alcançava ("O valor total do presente Contrato é de", "com valor inicial contratual de", "Valor Original/Valor Total" das telas SIAFE). Eram dois defeitos no mesmo lugar — recall e precisão — e a escolha passou a ser por **FORÇA DA DECLARAÇÃO**, com frequência desempatando só dentro da mesma força (a lição do G2 foi não adivinhar entre coisas DIFERENTES). Com a base certa, o teste de MAGNITUDE do X7 e o X1 inteiro foram a **ZERO** no topo da fila: nenhum dos 150 estoura o teto do art. 125 — não é anistia, os estouros eram artefato. ⚠️ **E um defeito meu:** ao ligar a família X, emiti achados escritos "X3 confirmado (intensidade 0.60)" e mais nada, porque o X3 confirma com `evidencia` VAZIA — o score sem explicação de novo, de roupa nova; sem prova literal não entra. Sobrou o que é **contável** e não depende de base: X7 14 ("2 exercícios com mais de uma recomposição", "12 recomposições no mesmo contrato") e X3 3. Suíte 4 lotes **5.575 verdes, 0 falhas**, 18 testes novos, 150 processos regravados.
- 2026-08-03 (madrugada): **auditei os 14 leitores dos `.txt` do acervo — e a etiqueta era o menor dos problemas.** Método: rodar TODO padrão compilado dos módulos que leem o acervo contra as **6.000 etiquetas reais**, medir em vez de deduzir. Dos 32 padrões que casavam, 26 casavam pelo **título** (do SEI, legítimo) e **6 pelo parêntese** (`(fase: … · tipo: …)`, palpite NOSSO) — esses eram o documento provando a si mesmo. 🚪 **Porta única** `compliance_agent/sei/acervo_texto`: `ler()` devolve o que o SEI serviu (padrão correto, ninguém precisa lembrar) e `etiqueta()` devolve o rótulo a quem legitimamente o quer — a `conferencia_captura`, e só ela, que agora o recebe explícito. Prova ponta a ponta: **0 de 4.370** textos ainda trazem etiqueta. ⚠️ Sutileza que custou uma medição: **nem todo `[` no começo é etiqueta** — documento real começa com colchete (`[RECEBEMOS DE PROMEFARMA…`) e título real tem colchete DENTRO (`[Anexo 7 - …-[SES_RJ] (80815818)]`); a âncora é o parêntese, e o casamento do título é guloso. 📏 **O dano maior não era o falso positivo, era a JANELA**: etiqueta com mediana 71 chars, p90 119 e **máximo medido 478** — quem lia `texto[:200]` (o acatamento do art. 53!) perdia 36,5% da janela, e `doc_juizo` ainda mandava a NOSSA classificação junto do documento para a IA que o julga. 🔍 **Três defeitos achados de raspão:** (1) **contar ARQUIVO não é contar TEXTO** — 10.323 dos 43.963 `.txt` (23,5%) trazem só a etiqueta, e o `captura_integra`, o portão que decide se um processo recebe faixa de risco, contava arquivos: 7 processos passavam por íntegros com metade dos textos vazios (a docstring já dizia "texto no disco decide"; não era o texto que decidia); (2) **o manifesto é o índice** — 6.286 `.txt` em 121 processos não eram reivindicados por entrada nenhuma e quem varria `texto/*.txt` lia DUAS capturas do mesmo processo (ressalva que me mordeu no meio: índice com `docs: []` é QUEBRADO, não vazio — confiar nele apagava 20 documentos reais em silêncio); (3) **recaptura cujo manifesto não foi reescrito** — novo `tools/sei_reconciliar_orfaos`, 338 documentos/3,0 MB no disco e fora do índice, título lido da ETIQUETA do próprio arquivo (casar por índice do nome colaria o teor de um documento no título de outro) e entrada superada só sai da contagem com **prova de título**: sem isso, 519 das 626 entradas de um processo virariam "superadas" quando só 88 têm substituta, e "não capturado" viraria "superado", apagando a fila de recaptura. 🛠️ **Reparo aplicado do que estava construído e nunca rodado:** manifestos zerados **33 → 0** (1.055 docs, 8,6 MB) — e a ferramenta gravava `chars` contando a etiqueta, o que faria arquivo só-rótulo passar por documento lido, ou seja, **o reparo fabricaria a mentira que a sentinela existe para achar**; mais 338 docs reconciliados e 2 capturas vazias saneadas: **1.393 documentos e 11,6 MB voltaram a existir para o motor**. 🚦 **Três catracas que tinham parado de guardar (anteriores a mim):** o normalizador do snapshot do Lex fixava `(aprendida da base JFN)`, o texto passou a `(aprendida da base histórica)` e ele deixou de casar EM SILÊNCIO (golden quebrou sozinho quando o SIAFE ingeriu 21.069 OBs); `intel_base` era o ÚNICO ponto do relatório que ignorava `JFN_DB`, então o snapshot "determinístico" ia à base viva; e `--update-rotas` estava documentado e **não existia** — a saída era apagar o golden à mão, que o regenera com o que estiver lá, inclusive uma rota perdida num refactor. Golden de números revisado com auditoria declarada (MGS +66, ITERJ +46, tudo de julho/2026 dia a dia = coleta incremental), **com um achado em aberto registrado no próprio teste**: a janela histórica do ITERJ caiu uma linha (−R$ 138.093,99), assinatura de deduplicação (4 OBs idênticas da LOCTECH em 2023, zero duplicatas hoje) — "consistente com" não é "provado". Suíte em 4 lotes: **5.544 passed, 6 skipped, 0 falhas**; **26 testes novos**; 39 processos reavaliados e regravados.
- 2026-08-03 (noite): **fechei a única pendência declarada: I1 e I2 abertos DOCUMENTO A DOCUMENTO.** Os 25 disparos do acervo foram lidos um a um — **I2 caiu 15→1 e I1 caiu 10→3**, e o caso-semente (`270131/000548/2023`) sobreviveu nos dois. Nenhum limiar mexido. Seis causas, nenhuma jurídica: (1) 🪞 **o documento provava a si mesmo** — o arquivo compacto prepõe ao `.txt` a linha `[título] (fase: … · tipo: parecer_juridico)`, e a palavra `juridico` DENTRO do texto fazia o "Parecer de Análise para Emissão DL" (corpo inteiro: *"Procedida a Revisão do processo"*, Diretoria Administrativa Financeira) passar no teste de manifestação jurídica **pela própria etiqueta que se queria conferir**; ⚠️ **a etiqueta contamina todo regex que leia esses `.txt` e só foi neutralizada em um módulo** (§ próximo passo 1 do handoff); (2) 📋 **rótulo de formulário lido como decisão** — toda NAD traz impresso `39 - APROVO E AUTORIZO ORDENADOR / AUTORIDADE DELEGADA`, assinada ou não: a nota do setor de orçamento virava o ato do ordenador (5 disparos); (3) peça que não é controle prévio (checklist, Declaração de Conformidade assinada por quem redigiu a minuta, Ato de Designação, Correspondência Interna) — **a doutrina do art. 53 tinha DUAS cópias prestes a divergir e agora tem uma só**, em `instrumento_assinatura`, importada pela `sintese_global`; (4) pedido lido como decisão (o título mente nos dois sentidos: "Despacho de Solicitação de Reserva Orçamentária" do INEA **é** o ato, e "de Análise da NAD" não é) → critério passou a ser o **verbo em 1ª pessoa**; (5) comparação min×min em processo de 4 anos com dezenas de NADs; (6) **parecer sem data legível ⇒ INDISPONÍVEL**. No I1: ordinal agora vem da fórmula de celebração (o Contrato 36/2023 citava "PRIMEIRO TERMO ADITIVO" numa cláusula e colidia com o aditivo real), lê **extenso**, exclui **publicação/apostilamento**, não acusa **minuta pendente nem minuta superada** (correção antes da assinatura é o controle FUNCIONANDO), e não conta **a mesma peça anexada duas vezes**. 📏 **Medição nova:** **1.969 documentos em 426 processos** estão cortados em 20.000 chars sem marca — a lista de recaptura conhece 1.660/375 e está defasada; **é a causa de 6 dos falsos positivos do I2** (o rodapé de assinatura mora no fim). 🐛 **Bug vivo curado:** o cron `sei_reparar_truncados --cap` abortava com `FileNotFoundError` quando o compactador trocava `.json` por `.json.zst` no meio da rodada — a exceção matava a execução **depois** de já ter afastado caches e o progresso, escrito só no fim, nunca era gravado: processos ficavam **sem cache E marcados como lidos**, exatamente o que o comentário do próprio arquivo adverte. **16 testes de regressão novos, um por falso positivo LIDO** (65 verdes no módulo; lote `sei/360/síntese/classificador/manifesto` **377 passed, 1 skipped**). Os 25 processos afetados foram **reavaliados e regravados** em `processo_avaliacao`. Handoff reescrito: `docs/HANDOFF-2026-08-03-DETECTORES-VALIDADOS.md`.
- 2026-08-03: **li processos originais e o confronto virou código; depois validei os detectores caso a caso.** Handoff completo em `docs/HANDOFF-2026-08-03-DETECTORES-VALIDADOS.md`; três confrontos em `docs/CONFRONTO-LEITURA-CLAUDE-*.md`. **Falsos positivos derrubados por LEITURA, não por limiar:** aditivo (55 proc.), pagamento (**697**), cancelado, fase pelo tipo canônico (**923 documentos** ganharam fase), e **202 processos sem uma letra lida** deixaram de receber faixa de risco (`NAO_AVALIAVEL`). 14 eram EXTREMO com ZERO achados — detector de fornecedor pontuava sem virar achado. **Detectores novos, todos calibrados no acervo:** I1..I7 (`sei/instrumento_assinatura`, 0,1%–0,7%) e C1 (`sei/conferencia_captura`, 364 processos / 2.106 documentos que o parecer prova faltarem). **Síntese GLOBAL** (`sei/sintese_global`): map-reduce ficha→fase→conjunto, ligada ao 360, persistida, na rota, no painel e no PDF (§II-B) — **2.174/2.174**. G3 caiu 73→2, G2 refeito 976→384, G1 refeito (pagamento antes do contrato; 0 no acervo). **Fim do corte de 20.000 chars** na leitura determinística (o Parecer 462 tem 54.900 e a conclusão ficava fora). **Erros meus que a casa pegou:** contei empenho como pagamento (só OB é pago), ordenei data como texto, e declarei um lote 'rodando' pelo `pgrep` que casou meu próprio comando. **PENDENTE:** I1 e I2 amostrados mas não abertos doc a doc; 10.447 documentos sem texto (recaptura pronta, WAF barrou); 323 processos em CONDICIONANTES_NAO_EXTRAIDAS.
- 2026-08-03 (loop 3 de qualidade): **a régua estava torta — consertar o instrumento antes de usá-lo.** O passo óbvio depois do loop 2 seria melhorar o prompt contra a catraca nova; não era. (1) 📏 **O harness mutilava o enunciado que media**: `_RE_DEVER_INICIAL` apagava o verbo de dever em QUALQUER posição (apesar do nome), devolvendo texto agramatical — 'podem e ser considerados', 'a Administração descontar as parcelas'. Efeito medido: **26 dos 58 casos `vicio_por_omissao` do holdout (45% da classe majoritária) lidos como `licito`** — o erro dominante da avaliação inteira. O modelo acertava o texto mutilado; errada era a régua. (2) **Mas devolver o verbo vaza o rótulo**: presente em 774 dos 776 `vicio_por_omissao` (100%) contra 36% de `vicio` e 24% de `licito` — a classe é propriedade da FORMA da frase, não da conduta. Medição principal passa a ser de **DUAS classes** (irregular × lícito), sem tocar no prompt (binariza-se ao pontuar, para isolar a mudança de RÉGUA), com **baseline deôntico** publicado ao lado (papagaio de uma linha: 'tem verbo de dever → irregular') e catraca que **recusa comparar modos diferentes** (`db11b89d`). (3) 🚨 **Queda de provedor virou 'qualidade zero' no painel** — o `gravar_ultima` do loop 2 publicou F1 0,0 quando todos os LLMs falharam, a mentira que o próprio `painel_acuracia` diz não aceitar. Guarda: acima de 30% de INDISPONÍVEL não se publica e o último número válido fica de pé. **A queda era em boa parte erro de invocação meu** (rodei sem `set -a; . ./.env`) — e a guarda funcionou. (4) 🔌 **O fallback Groq morria com `Illegal header value b'Bearer '`**: a chave era lida NO IMPORT, e processo que sobe antes do `.env` ficava com constante vazia; header vazio → httpx recusa → cooldown marca o provedor como fora do ar. O segundo provedor da rede de segurança sumia em silêncio, com a única pista sendo uma mensagem sobre HTTP. Resolve em `_chave()` a cada chamada e erra na hora dizendo o que falta (`8b622f8e`). (5) ⚖️ **'Sem parecer' eram três coisas**: dos 117 processos, **14** têm o parecer nos autos com 48-60 chars (só cabeçalho capturado), **42** são certidão tipada como `parecer_juridico` pelo classificador, **61** são parecer real de Secretaria cujo corpo não nomeia PGE/assessoria. Estado novo `PARECER_SEM_TEXTO_CAPTURADO` + porta estreita no gate de emissor (cabeçalho que anuncia 'PARECER Nº' basta, emissor sai **declarado** NAO_IDENTIFICADO, nunca inventado). Acervo: SEM_PARECER_LOCALIZADO **117 → 80**. Os 42 de tipo errado ficam como achado do classificador. (6) 📉 **A medição definitiva, com a régua consertada** (2 classes, enunciado íntegro, n=100): **acurácia 0,39 · F1 macro 0,448 · abstenção 34% · alucinação de citação 3%** — contra **baseline deôntico de acurácia 0,85 / F1 0,778**. Ou seja: **o motor não supera um regex de uma linha** ('tem verbo de dever → irregular'), e o card passou a dizer `insuficiente` — 'não use o veredito isolado para decidir nada'. Leitura fina: entre os 66 casos que ele RESPONDE (abstém-se em 34), acerta 59%; quando diz *irregular* acerta 29 de 31 (precisão alta), mas quando diz *lícito* erra 25 de 35 — **o viés é deixar passar, não acusar demais**, o que em controle externo é a falha cara. Ressalva honesta: o baseline deôntico é forte em parte POR CONSTRUÇÃO (o rótulo do corpus deriva da polaridade da tese do TCU, que mora no mesmo verbo) — mas é exatamente por isso que ele tem de ser publicado: prova que o corpus é gamificável pela forma, e nenhum número do motor pode ser lido sem ele. (7) 🧹 **A catraca de `except` estava vermelha desde antes desta série** (1625 × baseline 1596) sem ninguém documentar entrada a entrada. As 29 foram auditadas: nenhuma é muda — catch por detector que grava `indisponiveis`, 'não derruba o lote/cron', fronteira de Playwright e de LLM, idioma catch-and-return das rotas. **2 pagas** (1625→1623) e 27 documentadas por grupo; baseline a 1623. Suíte em lotes **1691 + 1269 + 1118 + 1586 verdes, zero falhas**. **28 testes novos.**
- 2026-08-02 (noite · loop 2 de qualidade): **o parecer lido pela metade e o botão que faltava.** (1) ⚖️ **339 processos deixaram de receber grau VERDE por falha de leitura**: com parecer reconhecido e nenhuma condicionante extraída, o veredito era `SEM_CONDICIONANTES`/verde/'nada a cobrar' — e 160 desses pareceres tinham linguagem de exigência. Estado novo `CONDICIONANTES_NAO_EXTRAIDAS` (amarelo) diz que o limite é de LEITURA da casa. Antes→depois: verde 378 → **39**; não-extraídas 0 → **332**; com condicionante 11 → **18**; primeiro `DESCUMPRIDO_INDICIO` do acervo (`5650c0a5`). (2) **Recall dos gatilhos** com formas colhidas no acervo ('sugere-se a', 'mediante o atendimento de', 'atendidas as recomendações', 'faz-se necessária'), e dois defeitos que apareceram no caminho: o veto de transcrição de norma não alcançava a citação legal porque o ponto de 'art. 92'/'14.133' fechava a janela, e a enumeração **'i) … ii)' sem parêntese de abertura não era item** — a lista virava UMA condicionante em bloco. (3) 🖱️ **O painel mandava o usuário 'dar POST' à mão**: processo não avaliado respondia 'POST /api/processo/avaliar' sem botão nenhum. A rota só 'tinha porta' porque duplicava o `/processo` no menu; tirada a duplicata, as catracas de rota órfã/sem superfície acenderam e o buraco apareceu. Cartão 'Avaliar um processo SEI' criado (`4a137c7c`). (4) **A catraca de capacidade-sem-porta contava dívida junto com decisão** — somava as 24 exceções declaradas com a dívida real, e limpar uma duplicata FAZIA o número subir (48→49). Agora mede só o não-justificado: teto **48 → 25**. (5) 🧭 **Painel percorrido como gente: 60 abas de 60** (antes 5), zero `pageerror`, zero erro de console; as 6 abas sem controle clicável são painéis de leitura legítimos — nenhum defeito de UX além do (3). (6) 🔬 **A hermenêutica nunca havia sido medida neste ambiente** (a aba Acurácia dizia isso e ninguém rodou): holdout COMPLETO medido e aceito como baseline (`data/hermeneutica_baseline.json`): **acurácia 0,43 · F1 macro 0,48 em 100 casos** — perto do acaso num problema de 3 classes. A amostra de 25 dava 0,64/0,71 e era otimista; vale o número cheio. O pior é a classe majoritária: `vicio_por_omissao` tem **recall 0,29 com n=58** (o motor deixa passar 71% do vício por omissão) e `licito` tem **precisão 0,29** (chama vício o que é lícito). Alucinação de citação 1%. É a métrica NÃO saturada que faltava ao loop, ao contrário do conjunto-ouro sintético do núcleo — e o prompt está em v1, então há onde melhorar com catraca de regressão. (7) `ouro_pareceres` passou a publicar **dois placares** (processo × família) — 'cobertura 0%' era enganoso: a casa apontou o processo, só não nomeou a família. Substrato ainda insuficiente (2 processos rotulados) → **não se promove** casos-ouro. **⚠ dívida ANTERIOR não paga:** `test_catraca_excepts` já estava vermelha em `6dd2b91d` (1625 vs baseline 1596, 29 capturas genéricas em 14 arquivos) — este loop não somou nenhuma. **8 testes novos.**
- 2026-08-02 (noite · loop 1 de qualidade): **o aprendizado era teatro; quatro defeitos medidos e curados.** (1) 🐛 **O PDF do 360 entregava 511 vereditos duplicados/retratados** — `_vereditos_persistidos` lia `doc_veredito` sem filtrar `rubrica_versao`: 50 dos 57 processos tinham juízo de 2-3 rubricas, inclusive v1/v2 que o próprio `doc_juizo` declara erradas. Um documento, um juízo (rubrica mais nova, comparação numérica): **1.084 → 573** (`402d2573`). (2) **O loop de autoaprimoramento não podia aprender**: 36 rodadas, 922 candidatos, **0 mantidos**, F1 travado em 1,0 sobre 8 casos sintéticos; `nucleo_feedback.json` nunca existiu e as 4.180 perícias têm `veredito_perito` nulo em 4.180. `diagnosticar_sinal` faz o diário/`/evolucao`/`/ciclo_nucleo` DENUNCIAREM saturação e régua 100% sintética (commitado junto de `604f7910` — a mensagem daquele commit cobre só a parte do painel). (3) 🐛 **O gate `e_parecer` descartava o próprio parecer**: dos 506 processos com documento de tipo canônico `parecer`, só 157 passavam — os outros 349 recebiam 'nenhum parecer entre os documentos LIDOS' (some a análise do art. 53 inteira). Causa: tipo canônico ignorado + veto anti-FP varrendo 3.000 chars e barrando o parecer por citar o aditivo sobre o qual OPINA. Veto agora é posicional no cabeçalho: **506/506** (`548524ff`). (4) **29.945 documentos sem rubrica nenhuma** — o ato que AUTORIZA o gasto nunca recebia análise subjetiva. Três rubricas novas (autorização de despesa, TR/projeto básico, pesquisa de preços) + entrada no `_PRIORIDADE` + fila do sweep_360 raciocinando por DOCUMENTO (o `distinct numero_sei` dava o processo por pronto no 1º despacho): superfície **7.651 → 9.049** elegíveis, **6.152 → 7.043** selecionados (`d4bfda4f`). (5) 🐛 **/api/pncp e /api/sei/direcionamento penduravam a aba** (`000` no health-check das 137 rotas GET): teto de 20 s + cache TTL 1 h, timeout NÃO cacheado; **zero rotas penduradas** na verificação (`604f7910`). **Novo `tools/ouro_pareceres.py`** (conjunto-ouro com rótulo humano do parecerista) mede e denuncia o gargalo seguinte: só **1 processo em 2.175** chega a rótulo utilizável porque `extrair_condicionantes` tem recall baixo — 160 pareceres com linguagem condicional, 11 com condicionante extraída. **17 testes novos.**
