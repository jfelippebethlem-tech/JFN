...
| `conflito_doador_contrato` | lex | http | `/api/conflito` | ONDA 2 | 'quem me doou ganhou contrato', conflito de interesse |
...
| `sobrepreco` | lex | http | `/api/sobrepreco` | ONDA 3 | 'esta caro?', superfaturamento, R4 |
