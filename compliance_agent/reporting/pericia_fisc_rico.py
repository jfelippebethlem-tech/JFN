...
_DET_META: dict[str, dict] = {
    ...
    "d8_credor_recem_aberto": {
        "rotulo": "D8 · Credor recém-aberto recebendo do município",
    ...
    "d10_rede_concorrentes": {
        ...
        "detecta": "Mesmo sócio (CPF ou nome) no QSA de ≥2 fornecedores contratados pelo mesmo órgão no ano — compatível com concorrência fictícia.",
        "irregularidade": "conluio",
        "dispositivos": ["Lei 14.133/2021 art. 9º", "Lei 12.529/2011 art. 36 §3º I", "Lei 8.666/93 art. 90"],
