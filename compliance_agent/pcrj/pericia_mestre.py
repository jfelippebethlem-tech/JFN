...
def montar_html(slug: str, db_path=None) -> str:
    ...
    caps.append(("cap-conflito", "Governança, Controle Societário e as Hipóteses de Conflito (BTG e BYD)", _p(
        ...
        + _p("A estrutura de controle é, ela própria, reveladora: o edital de convocação prevê a eleição "
             "do Conselho de Administração com " + _hl("dois membros indicados pela Acionista Controladora "
             "e apenas um pelos Acionistas Minoritários") + ", regidos por um <b>Acordo de Acionistas "
             "celebrado em 28/03/2024</b> — documento que disciplina o poder de controle e cuja obtenção é "
             "essencial. A Assembleia Geral Extraordinária originalmente marcada para 30/09/2025 foi "
             + _hl("adiada, por deliberação unânime dos acionistas, para 09/10/2025") + " (segunda "
             "convocação publicada em 02 e 03/10/2025), tendo por objeto a integralização de capital para "
             "<b>finalizar as obras</b> e a fixação da remuneração dos administradores — sinal de que, "
             "quase dois anos após a assinatura, a modernização ainda dependia de aporte de capital.",
             _hl("Em aberto (S.A. de capital fechado): os percentuais e a lista nominal de acionistas não "
             "são públicos e a respectiva ata não foi localizada em publicação jornalística até janeiro de "
             "2026") + " — por ser sociedade fechada, a companhia publica o edital de convocação, mas não "
             "necessariamente a íntegra da ata. A titularidade das ações consta do Livro de Registro de "
             "Ações Nominativas e dos atos arquivados na Junta Comercial. <b>Encaminhamentos:</b> "
             "(i) requisitar à JUCERJA a certidão da íntegra do NIRE 33.3.0035115-9 — ato de constituição, "
             "o <b>Acordo de Acionistas de 28/03/2024</b> e a ata da AGE de 09/10/2025 —, que identificam "
             "os acionistas e os percentuais; (ii) identificar o controlador final da Lotus ICT "
             "International Limited (indício Hong Kong/China) e apurar se o grupo Best Energy/Lotus ICT "
             "atua também como fornecedor dos equipamentos hospitalares (risco de duplo ganho); "
             "(iii) esclarecer qual 'Lotus' integra o consórcio; (iv) cotejar os pagamentos públicos já "
             "realizados com a execução física. Enquadramento, se comprovado favorecimento a qualquer "
             "parte: impessoalidade e moralidade (art. 37 da Constituição), Lei nº 14.133/2021 (arts. 9º e "
             "14) e Lei nº 12.813/2013 — jamais a Súmula Vinculante 13, que trata de nomeação para cargo. "
             "Tudo o que aqui se registra é indício sujeito a apuração.")))
