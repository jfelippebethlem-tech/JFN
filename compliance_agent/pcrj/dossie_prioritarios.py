...
def montar_ctx(db_path=None, faixa_min: str = "forte") -> dict:
    ...
    n = len(rows)
    passos = (
        "<p><b>Cada alvo desta lista é INDÍCIO por nome</b> — confirmar antes de qualquer "
        "conclusão:</p><ol>"
        "<li><b>Identidade (CPF/endereço) no cadastro/RH do órgão</b> — confirma se é a mesma "
        "pessoa e onde reside.</li>"
        "<li><b>Registro de ponto/frequência</b> — confirma (ou afasta) o funcionário fantasma: "
        "recebe sem comparecer.</li>"
        "<li><b>Processos por nome no tribunal (TJRJ/TRT1)</b> — reclamatória/processo em outra "
        "comarca (proxy de vínculo em outro lugar). Conferir <i>manualmente</i> (a busca por nome "
        "tem CAPTCHA) — são só estes " + str(n) + " nomes.</li>"
        "<li><b>Vínculo trabalhista concomitante</b> — conferir no cadastro de emprego do "
        "trabalhador.</li></ol>"
    ...
    return {
        ...
        "secoes": [
            ...
            {"titulo": "2. Como confirmar cada indício", "html": passos},
        ...
        "ressalva": "Indícios por nome; confirmar por identidade/ponto no órgão. Não usar base vazada.",
    }
