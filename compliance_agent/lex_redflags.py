...
_RF = {
    ...
    "R5": ("Inexigibilidade/dispensa possivelmente indevida", "Art. 74 Lei 14.133 / Art. 25 Lei 8.666 (revogada — fatos até 2023); art. 337-E CP (contratação direta ilegal)"),
    "R6": ("Alteração de controle societário após receita pública relevante", "Art. 14 Lei 14.133/2021 (idoneidade); art. 11 Lei 8.429/92 (dolo específico e rol taxativo — Lei 14.230/2021); ACFE — change-of-control/nominee"),
    "R7": ("Restrição de competitividade", "Art. 9º, I, Lei 14.133; Art. 3º §1º Lei 8.666 (revogada — fatos até 2023)"),
    "R8": ("Concentração de fornecedor / risco de captura (bid rigging)", "Art. 37 CF/88; Art. 36 §3º I 'd' Lei 12.529; ACFE/OCDE"),
    "R9": ("Aditivos sucessivos acima dos limites", "Arts. 125-126 Lei 14.133 (25%; 50% p/ reforma de edifício ou equipamento); Art. 65 §1º Lei 8.666 (revogada — fatos até 2023)"),
    "R10": ("Liquidação irregular / pagamento atípico (estornos)", "Arts. 62-63 Lei 4.320/64; Decreto 93.872/86 art. 38"),
    "R11": ("Atividade-fim (CNAE) incompatível com o objeto contratado", "Art. 62, II c/c art. 67 Lei 14.133 (qualificação técnica); art. 337-L CP (fraude em licitação ou contrato) SE comprovados dolo e entrega diversa; ACFE — shell company"),
    ...
    "R14": ("Conluio entre licitantes (rodízio/cobertura/supressão — OCDE)",
            "Art. 337-F CP (frustração do caráter competitivo — tipo inserido pelo art. 178 da Lei 14.133/2021; o antigo art. 90 da Lei 8.666/93 foi revogado); Art. 36 Lei 12.529/2011 (CADE)"),
    "R15": ("Parecer jurídico/controle prévio não acatado sem motivação",
            "Art. 53 Lei 14.133/2021 (controle prévio de legalidade); LINDB art. 22; art. 11 Lei 8.429/92 (dolo específico — Lei 14.230/2021)"),
    # Investigação de Due Diligence (fachada/laranja) — motor investigacao_dd; detalhe na seção II-E.
    "DD/H-END-RESID": ("Sede em endereço de natureza residencial", "indício de fachada — tipificação depende de DOLO e resultado (art. 337-L CP; Lei 8.429 art. 11, rol taxativo e dolo específico desde a Lei 14.230/2021)"),
    "DD/H-END-EXISTE": ("Endereço não confirmado fisicamente (geocodificação)", "indício de fachada — não tipifica por si; art. 337-L CP se comprovados dolo e fraude na execução"),
    "DD/H-COEND": ("Outros fornecedores do Estado na mesma sede", "indício de fachada — tipificação depende de DOLO e resultado (art. 337-L CP; Lei 8.429 art. 11, rol taxativo e dolo específico desde a Lei 14.230/2021)"),
    "DD/H-CAPITAL": ("Capital social ínfimo frente ao recebido", "art. 11 Lei 8.429/92 (exige dolo — Lei 14.230/2021); Art. 69 Lei 14.133 (qualificação econômico-financeira)"),
    "DD/H-RECENTE": ("Empresa recém-aberta antes do 1º recebimento", "indício de fachada — não tipifica por si; art. 337-L CP se comprovados dolo e fraude na execução"),
    "DD/H-SITUACAO": ("Situação cadastral irregular na Receita", "Art. 14 Lei 14.133; Art. 87 Lei 8.666/93 (revogada — fatos até 2023)"),
    "DD/H-PORTE": ("Volume recebido acima do teto do porte declarado", "LC 123/2006; Art. 4º Lei 14.133"),
    "DD/H-SOCIO-UNICO": ("Sócio único com sinais de fachada", "indício de fachada — tipificação depende de DOLO e resultado (art. 337-L CP; Lei 8.429 art. 11, rol taxativo e dolo específico desde a Lei 14.230/2021)"),
    "DD/H-PEP": ("Sócio politicamente exposto (PEP) — relação política", "Art. 9º Lei 14.133; Lei 12.813/13 (conflito de interesses); art. 11 Lei 8.429/92 (exige dolo — Lei 14.230/2021)"),
    "DD/H-BENEFICIO": ("Beneficiário de programa social de subsistência (laranja)", "indício de fachada — tipificação depende de DOLO e resultado (art. 337-L CP; Lei 8.429 art. 11, rol taxativo e dolo específico desde a Lei 14.230/2021)"),
}
