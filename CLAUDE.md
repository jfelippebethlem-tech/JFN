...
branch **`feat/lista-limpa`** · VM Linux GCP, `~/JFN`.
...
This project is indexed by GitNexus as **JFN** (8530 symbols, 20868 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
