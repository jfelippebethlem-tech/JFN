...
This project is indexed by GitNexus as **JFN** (23157 symbols, 32595 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
