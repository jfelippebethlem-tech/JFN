...
This project is indexed by GitNexus as **JFN** (50770 symbols, 75043 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
