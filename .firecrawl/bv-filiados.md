[Pular para o conteúdo](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/#main-content)
...
[Docs](https://brazilvisible.org/docs/)[APIs](https://brazilvisible.org/docs/apis/)[Justiça Eleitoral - TSE](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/)Filiados a Partidos

DocumentadoOffline

TSECSV DownloadCSVAuth: Não requerida

[eleições](https://brazilvisible.org/docs/tags/elei%C3%A7%C3%B5es/) [filiação partidária](https://brazilvisible.org/docs/tags/filia%C3%A7%C3%A3o%20partid%C3%A1ria/) [partidos políticos](https://brazilvisible.org/docs/tags/partidos%20pol%C3%ADticos/) [filiados](https://brazilvisible.org/docs/tags/filiados/) [militância](https://brazilvisible.org/docs/tags/milit%C3%A2ncia/) [base partidária](https://brazilvisible.org/docs/tags/base%20partid%C3%A1ria/)

# [Filiados a Partidos](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/\#filiados-a-partidos)

## [O que é](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/\#o-que-%C3%A9)
...
**Fonte oficial:** [https://dadosabertos.tse.jus.br/dataset/filiados](https://dadosabertos.tse.jus.br/dataset/filiados)

**Download direto (CDN):** [https://cdn.tse.jus.br/estatistica/sead/odsele/filiacao\_partidaria/](https://cdn.tse.jus.br/estatistica/sead/odsele/filiacao_partidaria/)

## [Como acessar](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/\#como-acessar)
...
### [Organização dos arquivos](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/\#organiza%C3%A7%C3%A3o-dos-arquivos)
...
## [Endpoints/recursos principais](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/\#endpointsrecursos-principais)
...
### [Download direto](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/\#download-direto)
...
## [Exemplo de uso](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/\#exemplo-de-uso)

### [Download e leitura de filiados de um partido](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/\#download-e-leitura-de-filiados-de-um-partido)
...
### [Análise da distribuição geográfica de filiados](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/\#an%C3%A1lise-da-distribui%C3%A7%C3%A3o-geogr%C3%A1fica-de-filiados)
...
### [Comparar tamanho da base de filiados entre partidos](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/\#comparar-tamanho-da-base-de-filiados-entre-partidos)
...
### [Análise de tendência de filiação ao longo do tempo](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/\#an%C3%A1lise-de-tend%C3%AAncia-de-filia%C3%A7%C3%A3o-ao-longo-do-tempo)
...
## [Campos disponíveis](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/\#campos-dispon%C3%ADveis)
...
## [Cruzamentos possíveis](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/\#cruzamentos-poss%C3%ADveis)

| Cruzamento | Fonte relacionada | Chave de ligação | Finalidade |
| --- | --- | --- | --- |
| Filiados x Candidatos | [Candidaturas](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/candidaturas) | `NOME_FILIADO` ↔ `NM_CANDIDATO` \+ `SG_PARTIDO` \+ `SG_UF` | Verificar filiação de candidatos e histórico partidário |
| Filiados x Eleitorado | [Eleitorado](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado) | `CODIGO_MUNICIPIO` \+ `ZONA_ELEITORAL` | Calcular taxa de filiação por zona/município em relação ao eleitorado |
| Filiados x Servidores | [Servidores Federais](https://brazilvisible.org/docs/apis/transparencia-cgu/servidores-federais) | `NOME_FILIADO` (aproximação) | Identificar servidores filiados a partidos (análise de afinidade política) |

### [Exemplo de cruzamento: taxa de filiação por município](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/\#exemplo-de-cruzamento-taxa-de-filia%C3%A7%C3%A3o-por-munic%C3%ADpio)
...
## [Limitações conhecidas](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/\#limita%C3%A7%C3%B5es-conhecidas)
...
[AnteriorEleitorado](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/) [PróximoPrestação de Contas](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/prestacao-contas/)

Nesta página

[O que é](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/#o-que-e) [Como acessar](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/#como-acessar) [Organização dos arquivos](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/#organizacao-dos-arquivos) [Endpoints/recursos principais](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/#endpointsrecursos-principais) [Download direto](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/#download-direto) [Exemplo de uso](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/#exemplo-de-uso) [Download e leitura de filiados de um partido](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/#download-e-leitura-de-filiados-de-um-partido) [Análise da distribuição geográfica de filiados](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/#analise-da-distribuicao-geografica-de-filiados) [Comparar tamanho da base de filiados entre partidos](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/#comparar-tamanho-da-base-de-filiados-entre-partidos) [Análise de tendência de filiação ao longo do tempo](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/#analise-de-tendencia-de-filiacao-ao-longo-do-tempo) [Campos disponíveis](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/#campos-disponiveis) [Cruzamentos possíveis](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/#cruzamentos-possiveis) [Exemplo de cruzamento: taxa de filiação por município](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/#exemplo-de-cruzamento-taxa-de-filiacao-por-municipio) [Limitações conhecidas](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/#limitacoes-conhecidas)
