[Pular para o conteúdo](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/#main-content)
...
[Docs](https://brazilvisible.org/docs/)[APIs](https://brazilvisible.org/docs/apis/)[Justiça Eleitoral - TSE](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/)Eleitorado

DocumentadoOffline

TSECSV DownloadCSVAuth: Não requerida

[eleições](https://brazilvisible.org/docs/tags/elei%C3%A7%C3%B5es/) [eleitorado](https://brazilvisible.org/docs/tags/eleitorado/) [perfil demográfico](https://brazilvisible.org/docs/tags/perfil%20demogr%C3%A1fico/) [eleitores](https://brazilvisible.org/docs/tags/eleitores/) [seção eleitoral](https://brazilvisible.org/docs/tags/se%C3%A7%C3%A3o%20eleitoral/) [faixa etária](https://brazilvisible.org/docs/tags/faixa%20et%C3%A1ria/) [escolaridade](https://brazilvisible.org/docs/tags/escolaridade/)

# [Eleitorado](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/\#eleitorado)

## [O que é](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/\#o-que-%C3%A9)
...
**Fonte oficial:** [https://dadosabertos.tse.jus.br/dataset/eleitorado](https://dadosabertos.tse.jus.br/dataset/eleitorado)

**Download direto (CDN):** [https://cdn.tse.jus.br/estatistica/sead/odsele/perfil\_eleitorado/](https://cdn.tse.jus.br/estatistica/sead/odsele/perfil_eleitorado/)

## [Como acessar](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/\#como-acessar)
...
### [Organização dos arquivos](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/\#organiza%C3%A7%C3%A3o-dos-arquivos)
...
## [Endpoints/recursos principais](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/\#endpointsrecursos-principais)
...
### [Download direto](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/\#download-direto)
...
## [Exemplo de uso](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/\#exemplo-de-uso)

### [Download e leitura do perfil do eleitorado](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/\#download-e-leitura-do-perfil-do-eleitorado)
...
### [Análise demográfica do eleitorado por UF](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/\#an%C3%A1lise-demogr%C3%A1fica-do-eleitorado-por-uf)
...
### [Perfil por faixa etária e escolaridade](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/\#perfil-por-faixa-et%C3%A1ria-e-escolaridade)
...
### [Carregar perfil por seção eleitoral (para cruzamento com votação)](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/\#carregar-perfil-por-se%C3%A7%C3%A3o-eleitoral-para-cruzamento-com-vota%C3%A7%C3%A3o)
...
## [Campos disponíveis](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/\#campos-dispon%C3%ADveis)

### [Perfil do eleitorado](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/\#perfil-do-eleitorado)
...
### [Faixas etárias disponíveis](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/\#faixas-et%C3%A1rias-dispon%C3%ADveis)
...
## [Cruzamentos possíveis](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/\#cruzamentos-poss%C3%ADveis)

| Cruzamento | Fonte relacionada | Chave de ligação | Finalidade |
| --- | --- | --- | --- |
| Eleitorado x Votação | [Resultados Eleitorais](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/resultados-eleitorais) | `CD_MUNICIPIO` \+ `NR_ZONA` \+ `NR_SECAO` | Correlacionar perfil demográfico com padrões de votação |
| Eleitorado x Boletins de urna | [Boletins de Urna](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/boletins-urna) | `CD_MUNICIPIO` \+ `NR_ZONA` \+ `NR_SECAO` | Análise granular de votação versus perfil por seção |
| Eleitorado x Filiados | [Filiados a Partidos](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos) | `CD_MUNICIPIO` \+ `NR_ZONA` | Calcular taxa de filiação em relação ao eleitorado |
| Eleitorado x Candidatos | [Candidaturas](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/candidaturas) | `CD_MUNICIPIO` / `SG_UF` | Comparar perfil do eleitorado com perfil dos candidatos |

### [Exemplo de cruzamento: perfil demográfico versus votação](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/\#exemplo-de-cruzamento-perfil-demogr%C3%A1fico-versus-vota%C3%A7%C3%A3o)
...
## [Limitações conhecidas](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/\#limita%C3%A7%C3%B5es-conhecidas)
...
[AnteriorCandidaturas](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/candidaturas/) [PróximoFiliados a Partidos](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/filiados-partidos/)

Nesta página

[O que é](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/#o-que-e) [Como acessar](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/#como-acessar) [Organização dos arquivos](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/#organizacao-dos-arquivos) [Endpoints/recursos principais](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/#endpointsrecursos-principais) [Download direto](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/#download-direto) [Exemplo de uso](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/#exemplo-de-uso) [Download e leitura do perfil do eleitorado](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/#download-e-leitura-do-perfil-do-eleitorado) [Análise demográfica do eleitorado por UF](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/#analise-demografica-do-eleitorado-por-uf) [Perfil por faixa etária e escolaridade](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/#perfil-por-faixa-etaria-e-escolaridade) [Carregar perfil por seção eleitoral (para cruzamento com votação)](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/#carregar-perfil-por-secao-eleitoral-para-cruzamento-com-votacao) [Campos disponíveis](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/#campos-disponiveis) [Perfil do eleitorado](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/#perfil-do-eleitorado) [Faixas etárias disponíveis](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/#faixas-etarias-disponiveis) [Cruzamentos possíveis](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/#cruzamentos-possiveis) [Exemplo de cruzamento: perfil demográfico versus votação](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/#exemplo-de-cruzamento-perfil-demografico-versus-votacao) [Limitações conhecidas](https://brazilvisible.org/docs/apis/justica-eleitoral-tse/eleitorado/#limitacoes-conhecidas)
